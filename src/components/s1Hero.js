...
const S1Hero = ({ bgImage, Title, Description, locationName, locationAddress, locationPhoneNumber, menuButtonAttributes }) => {
  return (
    <>
      <section
      ...
      >
        <div className="container flex flex-col items-center justify-center px-5 py-24 mx-auto lg:pb-8  min-h-[672px]">
          <div className="mx-auto mb-5 lg:w-1/4 animate-fade-in-fwd">
            ...
            <div className="mx-auto text-center text-white fontFredoka">
              <span className="text-xl text-center fontFredoka" style={{ textShadow: "2px 2px 4px black" }}>{locationName}</span>
              <span className="block text-lg text-center" style={{ textShadow: "2px 2px 4px black" }}>{locationAddress}</span>
              <span className="block text-lg text-center" style={{ textShadow: "2px 2px 4px black" }}>{locationPhoneNumber}</span>
            </div>
          </div>
