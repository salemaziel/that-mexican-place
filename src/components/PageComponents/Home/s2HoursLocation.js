        ...
        <Fade direction="up" triggerOnce>
          <div className="container flex flex-col text-gray-800 bg-white border border-gray-200 rounded-lg shadow-xl md:flex-row rounded-xl">
            <div className="w-full mx-auto">
              <iframe
                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3340.8302429052183!2d-117.09370068470827!3d33.13982408086392!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x80dbf4b028a9c805%3A0x2f75747a6e44876c!2sThat%20Mexican%20Place!5e0!3m2!1sen!2sus!4v1612178335240!5m2!1sen!2sus"
                width="100%"
                height="100%"
              ...
              <div id="location" className="">
                ...
                <div className="px-5 pt-5 mx-auto mb-10 text-2xl text-left md:pl-10 lg:pl-32">
                  ...
                  <div className="flex justify-center mx-auto lg:px-3">
                    ...
                    <a
                      href="https://www.google.com/maps/dir//That+Mexican+Place,+200+W+El+Norte+Pkwy,+Escondido,+CA+92026/@33.1398241,-117.0937007,17z/data=!4m8!4m7!1m0!1m5!1m1!1s0x80dbf4b028a9c805:0x2f75747a6e44876c!2m2!1d-117.091512!2d33.1398241"
                      className="text-left text-red-700 underline "
                    >
                      {' '}
                      200 W El Norte Pkwy Suite 9<br />
                      Escondido, CA 92026{' '}
                    </a>
                  </div>
                  ...
                  <div className="flex justify-center mx-auto lg:px-3">
                    ...
                    <a href="tel:760743-3783" className="text-left text-red-700 underline lg:px-5">
                      {' '}
                      (760) 743-3783{' '}
                    </a>
                  </div>
