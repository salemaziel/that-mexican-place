      ...
      >
        <div className="container flex flex-col items-center justify-center px-5 py-24 mx-auto lg:pb-8 animate-fade-in-fwd">
          ...
          <div className='hidden lg:flex lg:flex-row w-full justify-evenly'>
            ...
            <Link className="w-1/2 mb-5 lg:w-1/4 hover:bg-black hover:bg-opacity-50 focus:bg-black focus:opacity-50" to="/escondido"
              onClick={() => {
                onSelect('escondido');
                navigate('/escondido');
              }}
            ...
            <Link className="w-1/2 mb-5 lg:w-1/4 hover:bg-black hover:bg-opacity-50 focus:bg-black focus:opacity-50" to="/hemet"
              onClick={() => {
                onSelect('hemet');
                navigate('/hemet');
              }}
