  ...
  return (
    <>
      <GatsbySeo
        ...
        description="That Mexican Place is a Mexican restaurant located in Hemet, CA. Mexican food near Hemet."
        canonical="https://thatmexicanplace.net"
        openGraph={{
          url: 'https://thatmexicanplace.net/locations/hemet',
          title: 'That Mexican Place',
          locale: 'en_US',
          description: 'That Mexican Place is a Mexican restaurant located at Hemet, CA. Mexican food near Hemet.',
          images: [
            {
