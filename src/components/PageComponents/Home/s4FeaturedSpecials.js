  ...
  <div className="pb-10 overflow-x-scroll hide-scroll-bar">
    <div className="flex ml-10 flex-nowrap lg:ml-40 md:ml-20 ">
      ...
      <div className="inline-block px-3">
        ...
        <div id="card" className="w-64 h-auto max-w-xs overflow-hidden transition-shadow duration-300 ease-in-out bg-white rounded-lg shadow-md hover:shadow-xl">
            ...
            <div className="w-full px-5 mx-auto my-5 font-bold text-center">
                ...
                Ultrices mi tempus imperdiet nulla malesuada. Nec ultrices dui sapien eget mi proin sed libero. Orci nulla pellentesque dignissim enim sit amet venenatis.
                </p>
            </div>
        </div>
      </div>
